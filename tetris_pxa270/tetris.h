...
/* Frame dimension */
#define FRAMEW (int)(10)
#define FRAMEH (int)(15)
#define FRAMEW_NB 5
#define FRAMEH_NB 5
...
#define DRAW_SCORE() set_color(Score);                             \
     ...
     set_color(0);						\
	_7SEG_put_led(fd, _7SEG_D5_INDEX, score/1000);			\
	  _7SEG_put_led(fd, _7SEG_D6_INDEX, (score/100)%10);			\
	  _7SEG_put_led(fd, _7SEG_D7_INDEX, (score/10)%10);			\
	  _7SEG_put_led(fd, _7SEG_D8_INDEX, score%10);
